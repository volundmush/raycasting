...
The starting code creates an image of two spheres.
**But, there is no shading and there is no plane. You will need to extend the code to create the functions for plane intersection and the Phong reflection (shading) model.**
